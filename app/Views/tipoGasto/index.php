    ...
    <div class="col-12">
        <div class="page-title-box">
            <div class="page-title">
                <h3 class="page-title">Tipo Gasto</h3>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12 col-sm-12">
        <div class="card">
            <div class="card-body">
                <form action="/tipo-gasto/create" method="POST" class="row g-3">
                    <div class="col-md-4">
        ...
        <div class="card">
            <div class="card-body">
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        <?php foreach ($tipoGasto as $tg) : ?>
                            <tr>
                                <td><?= $tg->descricao ?></td>
                                <td class="text-center">
                                    <?= anchor("/tipo-gasto/remove/$tg->idTipoGasto", "remover", ["class" => "btn btn-outline-danger btn-sm", "onclick" => "return db.confirma()"]) ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
